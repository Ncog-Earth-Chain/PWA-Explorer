            ...
            <template v-if="!dTransactionByHashError">
                ...
                <template v-else>
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToNEC(cTransaction.value) }} NEC</div></div>
                    </div>
                    <!--
                                <div class="row no-collapse">
                                    <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToNEC(cTransaction.fee) }} NEC</div></div>
                                </div>
                    -->
                    <div class="row no-collapse">
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} NEC</div></div>
                    </div>
                    <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToNEC(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
