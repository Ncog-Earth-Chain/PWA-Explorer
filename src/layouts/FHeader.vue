    ...
    <header class="f-header" :class="cCssClass">
        <div class="narrow-container">
            <div class="row no-collapse align-items-center">
                <div class="col-2">
                    <router-link to="/" class="logo" :aria-label="$t('view_home.back_to_home')"><img src="/ncogearthchain-logo.svg" alt="" class="not-fluid"></router-link>
                </div>
        ...
        <div class="f-drawer" @click="onDrawerClick">
            ...
            <div class="footer">
                ...
                <div class="copyright">
                    <a href="https://ncogchain.earth/" target="_blank" rel="nofollow">©2022 NCOG Earth Chain</a>
                </div>
            </div>
        </div>
    </header>
