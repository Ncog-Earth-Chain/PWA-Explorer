                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'stake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToNEC(cStaker.stake), 0)) }} NEC
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'delegatedMe' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToNEC(cStaker.delegatedMe), 0)) }} NEC
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'totalStake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToNEC(cStaker.totalStake), 0)) }} NEC
                        </div>
                    </div>
                </div>
