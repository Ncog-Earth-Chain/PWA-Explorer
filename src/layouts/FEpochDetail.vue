                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div class="break-word">
                            <n-e-c-token-value :value="cEpoch.totalBaseRewardWeight" convert />
                        </div>
                    </div>
                </div>
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div class="break-word">
                            <n-e-c-token-value :value="cEpoch.epochFee" convert />
                        </div>
                    </div>
                </div>
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div class="break-word">
                            <n-e-c-token-value :value="cEpoch.totalTxRewardWeight" convert />
                        </div>
                    </div>
                </div>
            </template>
