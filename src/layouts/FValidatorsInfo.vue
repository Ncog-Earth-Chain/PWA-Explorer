                ...
                <div class="col margin-bottom-menu">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fSelfStaked' in dTotals">{{ dTotals.fSelfStaked }} NEC <span v-if="cSelfStaked">({{ cSelfStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalDelegated' in dTotals">{{ dTotals.fTotalDelegated }} NEC <span v-if="cDelegated">({{ cDelegated }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalStaked' in dTotals">{{ dTotals.fTotalStaked }} NEC <span v-if="cStaked">({{ cStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="cDailyRewards">{{ formatNumberByLocale(numToFixed(cDailyRewards, 0)) }} NEC</div>
                            </div>
                        </div>
                ...
                <div class="col">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'epochFee' in cEpoch">{{  WEIToNEC(cEpoch.epochFee) }} NEC</div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="dTotalSupply">{{ formatNumberByLocale(numToFixed(dTotalSupply, 0)) }} NEC</div>
                            </div>
                        </div>
                    </f-card>
                </div>
    ...
    export default {
        ...
        apollo: {
            ...
            epoch: {
                ...
                result(_data) {
                    this.dTotalSupply = WEIToNEC(_data.data.epoch.totalSupply);
                },
                error(_error) {
                    this.dValidatorsInfoError = _error.message;
                }
