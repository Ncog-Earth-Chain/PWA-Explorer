...
-->
                ...
                <!--
                            <template v-slot:column-fee="{ value, column }">
                                <div v-if="column" class="row no-collapse no-vert-col-padding">
                                    <div class="col-5 f-row-label">{{ column.label }}</div>
                                    <div class="col">{{ WEIToNEC(value | formatHexToInt) }}</div>
                                </div>
                                <template v-else>
                                    {{ WEIToNEC(value | formatHexToInt) }}
                                </template>
                            </template>
                -->
...
*/
                    ...
                    {
                        name: 'amount',
                        label: `${this.$t('view_transaction_list.amount')} (NEC)`,
                        itemProp: `${!this.withoutCursor ? 'transaction.' : ''}value`,
                        formatter: _value => {
                            // return formatNumberByLocale(numToFixed(WEIToNEC(_value), 2), 2)
                            return WEIToNEC(_value);
                        },
                        width: '150px',
                        css: {
                            textAlign: 'right'
...
/*
                    {
                        name: 'fee',
                        label: `${this.$t('view_transaction_list.fee')} (NEC)`,
                        itemProp: 'gasUsed',
                        width: '130px'
                    }
*/
