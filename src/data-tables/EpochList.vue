    ...
    data() {
        return {
            ...
            dColumns: [
                ...
                /*{
                    name: 'baseReward',
                    label: this.$t('epoch.total_base_reward') + ' (NEC)',
                    itemProp: 'epoch.totalBaseRewardWeight',
                    formatter: (_value) => formatNumberByLocale(WEIToNEC(_value), 1, 2),
                    cssClass: 'align-end',
                },*/
                {
                    name: 'fee',
                    label: this.$t('epoch.total_fee') + ' (NEC)',
                    itemProp: 'epoch.epochFee',
                    formatter: (_value) => WEIToNEC(_value),
                    cssClass: 'align-end',
                },
                /*{
                    name: 'txReward',
                    label: this.$t('epoch.total_tx_reward') + ' (NEC)',
