                    ...
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            <div class="validator-img">
                                ...
                                <img v-else src="/img/ncogearthchain-logo.png" alt="ncogearthchain logo" class="not-fluid">
                            </div>
                        </div>
                    </div>
                    <template v-else>
                ...
                result(_data, _key) {
                    ...
                    if (_key === 'stakers') {
                        ...
                        data.forEach((_item, _idx) => {
                            // _item.total_staked = WEIToNEC(_item.stake) + WEIToNEC(_item.delegatedMe);
                            totals.selfStaked += parseFloat(numToFixed(WEIToNEC(_item.stake), 0));
                            totals.totalDelegated += parseFloat(numToFixed(WEIToNEC(_item.delegatedMe), 0));
                            totals.totalStaked += parseFloat(numToFixed(WEIToNEC(_item.totalStake), 0));
            ...
            return {
                ...
                dColumns: [
                    ...
                    },
                    {
                        ...
                        formatter: _value => formatNumberByLocale(numToFixed(WEIToNEC(_value), 0), 0),
                        sortFunc: sortByHex,
                        cssClass: 'align-end',
                    },
                    {
